...
// // Fetch songs
// fetch('https://itunes.apple.com/search?term=jubin+nautiyal&media=music&limit=1000')
//   .then(res => res.json())
//   .then(data => {
...
//     <path id="primary" d="M7,3H9a1,1,0,0,1,1,1V20a1,1,0,0,1-1,1H7a1,1,0,0,1-1-1V4A1,1,0,0,1,7,3Zm8,18h2a1,1,0,0,0,1-1V4a1,1,0,0,0-1-1H15a1,1,0,0,0-1,1V20A1,1,0,0,0,15,21Z" style="fill: none; stroke: rgb(0, 0, 0); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"></path>
//   `;
// }

// function showPlayIcon() {
//   playPauseIcon.innerHTML = `
//     <path id="primary" d="M6,4l14,8L6,20Z" style="fill: none; stroke: rgb(0, 0, 0); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"></path>
//   `;
// }
...
// Global variables
const artists = ['Diljit Dosanjh','Satinder Sartaaj','arijit singh','shiva  choudhari', 'jubin nautiyal', 'shreya ghoshal'];
let songs = [];
let currentSongIndex = 0;
